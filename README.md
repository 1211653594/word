...
## API的价值主张
- 文本审核：在用户输入一段文字后，该API可判断一段文本内容是否符合网络发文规范，对文本中内容进行识别。
...
## 后风险报告
- 由于文本审核目前还在测试阶段，故可能产生的风险会比较多。
- 而文本纠错目前已经成熟，可能产生的风险并不高。
- 两款API的AI概率性目前并没有被百度公司公布出来，考虑到文本的多样性和复杂性，相信百度公司也很难提供出一个统一的概率性内容。